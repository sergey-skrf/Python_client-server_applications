...
class Server:
    ...
    def process_client_message(message, messages_list, client):
        ...
        if ACTION in message and message[ACTION] == PRESENCE and TIME in message \
            ...
            MessageProcessing.send_message(client, {RESPONSE: 200})
            return
        ...
        # Иначе отдаём Bad request
            ...
            MessageProcessing.send_message(client, {RESPONSE: 400, ERROR: 'Bad Request'})
            return
        ...
        while True:
                ...
                for client_with_message in recv_data_lst:
                    try:
                        Server.process_client_message(
                            MessageProcessing.get_message(client_with_message), messages, client_with_message)
                    except:
            ...
            if messages and send_data_lst:
                ...
                for waiting_client in send_data_lst:
                    try:
                        MessageProcessing.send_message(waiting_client, message)
                    except:
