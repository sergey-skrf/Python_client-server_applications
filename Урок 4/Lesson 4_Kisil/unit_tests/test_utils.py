...
class Tests(unittest.TestCase):
    ...
    def test_send_message(self):
        ...
        MessageProcessing.send_message(test_socket, self.test_dict_send)
    ...
    def test_get_message(self):
        ...
        self.assertEqual(MessageProcessing.get_message(test_sock_ok), self.test_dict_recv_ok)
        # тест корректной расшифровки ошибочного словаря
        self.assertEqual(MessageProcessing.get_message(test_sock_err), self.test_dict_recv_err)
